...
//@SpringBootTest  // 모든 컨트롤러의 경우를 테스트 하므로 자원이 소비된다.
@AutoConfigureWebMvc
...
//
//        mockMvc.perform(
                    // put , delete 다 똑같다 밑에 post 만 바꿔주면 된다.
                                        //put("http://localhost:8080/api/minus")
                                        //delete("http://localhost:8080/api/minus")
//                MockMvcRequestBuilders.post("http://localhost:8080/api/minus")
//                        .contentType(MediaType.APPLICATION_JSON)
//                        .content(json)
//        ).andExpect(
